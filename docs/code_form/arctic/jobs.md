...
Des tableaux **Partitions pour architectures spécifiques** (GPU notamment) et **Partitions pour calculs parallèles** figurent sur le lien précédent.

Domaine IA - deep laerning : lire sa [page consacrée](https://services.criann.fr/services/hpc/cluster-austral/guide/ia-deep-learning/#utilisation) et sa section **Utilisation**
